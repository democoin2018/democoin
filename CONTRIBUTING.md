Contributing to Demo Coin Core
==================================

The Demo Coin Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Demo Coin Core project, and is not to be
confused with overall Demo Coin Network Protocol consensus changes.

Whether a pull request is merged into Demo Coin Core rests with the project merge
...
Patches that change Demo Coin consensus rules are considerably more involved than
...
Where a patch set proposes to change the Demo Coin consensus, it must have been
...
The project leader is the release manager for each Demo Coin Core release.

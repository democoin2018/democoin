...
Demo Coin now supports full decentralized budgets that are paid directly from the blockchain via superblocks once per month.
...
mnbudget prepare \<proposal-name\> \<url\> \<payment_count\> \<block_start\> \<democoin_address\> \<monthly_payment_democoin\> [use_ix(true|false)]
...
In this transaction we prepare collateral for "_cool-project_". This proposal will pay _1200_ DCN, _12_ times over the course of a year totaling _24000_ DCN.
...
mnbudget submit \<proposal-name\> \<url\> \<payment_count\> \<block_start\> \<democoin_address\> \<monthly_payment_democoin\> \<collateral_hash\>
...
When block `1000000` is reached you'll receive a payment for `1200` DCN.
 ...
 * vote-many          - Vote on a Demo Coin initiative
 * vote-alias         - Vote on a Demo Coin initiative
 * vote               - Vote on a Demo Coin initiative/budget

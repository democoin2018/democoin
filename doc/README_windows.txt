...
Intro
-----
Demo Coin (DCN) is a sustainable cryptocurrency modeled after 
...
high-powered mining hardware. Demo Coin utilizes an energy efficient proof-of-stake algorithm, 
...
Demo Coin Core is the original Demo Coin client and it builds the backbone of the network.
However, it downloads and stores the entire history of Demo Coin transactions;

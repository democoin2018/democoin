...
In order to support loading of multiple wallets in democoin-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is democoin.cpp.
...
Changes to democoin.cpp
----------------------
democoin.cpp is the entry point into democoin-qt, and as such, will require some minor modifications to provide hooks for

...
// Copyright (c) 2017 The Demo Coin developers
...
static Checkpoints::MapCheckpoints mapCheckpoints =
    ...
    (0, uint256("0x000002a0c85757d28e9d45f73b15cfbf1b2fb88b6ba7e4a5197ed1384d09dab3"));
...
public:
    CMainParams()
    {
        ...
        nMinerThreads = 0;
        nTargetTimespan = 1 * 60; // Demo Coin: 1 day
        nTargetSpacing = 2 * 60;  // Demo Coin: 2 minutes
        nMaturity = 10;
        ...
        nLastPOWBlock = 200;
        nModifierUpdateBlock = 1; // we use the version 2 for DCN
         ...
         */
        const char* pszTimestamp = "Democoin Starts";
        CMutableTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        txNew.vin[0].scriptSig = CScript() << 486604799 << CScriptNum(4) << vector<unsigned char>((const unsigned char*)pszTimestamp, (const unsigned char*)pszTimestamp + strlen(pszTimestamp));
        txNew.vout[0].nValue = 0 * COIN;
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("04e5a8143f86ad8ac63712fbbdb8e0b91a8da88c8c693a95f6c2c13c063ea790f7960b8025a9047a7bc671d5cfe707a2dd2e13b86182e1064a0eea7bf863636363") << OP_CHECKSIG;
        genesis.vtx.push_back(txNew);
        genesis.hashPrevBlock = 0;
        genesis.hashMerkleRoot = genesis.BuildMerkleTree();
        genesis.nVersion = 1;
        genesis.nTime = 1524078518;
        genesis.nBits = 0x1e0ffff0;
        genesis.nNonce = 1632945;
					
        hashGenesisBlock = genesis.GetHash();
        assert(hashGenesisBlock == uint256("0x000002a0c85757d28e9d45f73b15cfbf1b2fb88b6ba7e4a5197ed1384d09dab3"));
        assert(genesis.hashMerkleRoot == uint256("0xdcdf974b07dd852ed36b73d89f95f9c54492fa435b1f780922d418ed06cee060"));

        // DNS Seeding
        vSeeds.push_back(CDNSSeedData("206.189.65.122", "206.189.65.122"));

        // Demo Coin addresses start with 'G'
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 38);
        // Demo Coin script addresses start with '3'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 6);
        // Demo Coin private keys start with 'K'
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 46);
        // Demo Coin BIP32 pubkeys start with 'xpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x04)(0x88)(0xB2)(0x1E).convert_to_container<std::vector<unsigned char> >();
        // Demo Coin BIP32 prvkeys start with 'xprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x04)(0x88)(0xAD)(0xE4).convert_to_container<std::vector<unsigned char> >();
        // Demo Coin BIP44 coin type is '222' (0x800000de)
...
public:
    CTestNetParams()
    {
        ...
        nMinerThreads = 0;
        nTargetTimespan = 1 * 60; // Demo Coin: 1 day
        nTargetSpacing = 2 * 60;  // Demo Coin: 1 minute
        nLastPOWBlock = 200;
        nMaturity = 15;
        ...
        // Testnet Demo Coin addresses start with 'g'
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 98);
        // Testnet Demo Coin script addresses start with '5' or '6'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 12);
        // Testnet private keys start with 'k'
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 108);
        // Testnet Demo Coin BIP32 pubkeys start with 'tpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x04)(0x35)(0x87)(0xCF).convert_to_container<std::vector<unsigned char> >();
        // Testnet Demo Coin BIP32 prvkeys start with 'tprv' (Bitcoin defaults)
...
public:
    CRegTestParams()
    {
        ...
        nToCheckBlockUpgradeMajority = 1000;
        nMinerThreads = 1;
        nTargetTimespan = 24 * 60 * 60; // Demo Coin: 1 day
        nTargetSpacing = 2 * 60;        // Demo Coin: 1 minutes
        bnProofOfWorkLimit = ~uint256(0) >> 1;
        genesis.nTime = 1524048518;
        ...
        hashGenesisBlock = genesis.GetHash();
        nDefaultPort = 23133;
        assert(hashGenesisBlock == uint256("0x7858950c77c790beca186ff0abdebf62d13a3239a55ee3ce0023f8bdb80214e4"));

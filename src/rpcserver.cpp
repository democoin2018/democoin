...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop Demo Coin server.");
    // Shutdown will take long enough that the response should get back
    StartShutdown();
    return "Demo Coin server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Demo Coin features */
        {"democoin", "masternode", &masternode, true, true, false},
        {"democoin", "listmasternodes", &listmasternodes, true, true, false},
        {"democoin", "getmasternodecount", &getmasternodecount, true, true, false},
        {"democoin", "masternodeconnect", &masternodeconnect, true, true, false},
        {"democoin", "masternodecurrent", &masternodecurrent, true, true, false},
        {"democoin", "masternodedebug", &masternodedebug, true, true, false},
        {"democoin", "startmasternode", &startmasternode, true, true, false},
        {"democoin", "createmasternodekey", &createmasternodekey, true, true, false},
        {"democoin", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"democoin", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"democoin", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"democoin", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"democoin", "getmasternodescores", &getmasternodescores, true, true, false},
        {"democoin", "mnbudget", &mnbudget, true, true, false},
        {"democoin", "preparebudget", &preparebudget, true, true, false},
        {"democoin", "submitbudget", &submitbudget, true, true, false},
        {"democoin", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"democoin", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"democoin", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"democoin", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"democoin", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"democoin", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"democoin", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"democoin", "checkbudgets", &checkbudgets, true, true, false},
        {"democoin", "mnsync", &mnsync, true, true, false},
        {"democoin", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET

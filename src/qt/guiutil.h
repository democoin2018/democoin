...
/** Utility functions used by the DemoCoin Qt UI.
 */
namespace GUIUtil
{
...
// Render DCN addresses in monospace font
...
// Parse "democoin:" URI into recipient object, return true on successful parsing

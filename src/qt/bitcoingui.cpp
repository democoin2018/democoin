                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Demo Coin Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a DCN address"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Demo Coin Core"), this);
    aboutAction->setStatusTip(tr("Show information about Demo Coin Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Demo Coin"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your DCN addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified DCN addresses"));
    ...
    showHelpMessageAction->setStatusTip(tr("Show the Demo Coin Core help message to get a list with possible Demo Coin command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Demo Coin Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Demo Coin network", "", count));
}
...
{
    QString strTitle = tr("Demo Coin Core"); // default title

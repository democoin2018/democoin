...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Demo Coin Core"),
     ...
     * override -datadir in the democoin.conf file in the default data directory
     * (to be consistent with democoind behavior)
     */
    if (dataDir != getDefaultDataDirectory())

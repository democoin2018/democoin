...
#if defined(NDEBUG)
#error "Demo Coin cannot be compiled without assertions."
#endif
...
/** Fees smaller than this (in udcn) are considered zero fee (for relaying and mining)
...
{
    RenameThread("democoin-scriptch");
...
bool static ProcessMessage(CNode* pfrom, string strCommand, CDataStream& vRecv, int64_t nTimeReceived)
{
    ...
    if (strCommand == "version") {
        ...
        // DCN: We use certain sporks during IBD, so check to see if they are

...
#   c) node1 mines 32 blocks, so now node 0 has 500000DCN, node 1 has 4250DCN, node2 has none.
#   d) node0 sends 601 DCN to node2, in two transactions (301 DCN, then 300 DCN).

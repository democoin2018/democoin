...
RESOURCES += src/qt/democoin.qrc src/qt/democoin_locale.qrc

TRANSLATIONS += src/qt/locale/democoin_bg.ts \
                src/qt/locale/democoin_de.ts \
                src/qt/locale/democoin_en.ts \
                src/qt/locale/democoin_es.ts \
                src/qt/locale/democoin_fi.ts \
                src/qt/locale/democoin_fr.ts \
                src/qt/locale/democoin_it.ts \
                src/qt/locale/democoin_ja.ts \
                src/qt/locale/democoin_pl.ts \
                src/qt/locale/democoin_pt.ts \
                src/qt/locale/democoin_ru.ts \
                src/qt/locale/democoin_sk.ts \
                src/qt/locale/democoin_sv.ts \
                src/qt/locale/democoin_vi.ts \
                src/qt/locale/democoin_zh_CN.ts \
                src/qt/locale/democoin_zh_TW.ts
